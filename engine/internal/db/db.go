// Package db handles InstaGuard's SQLite configuration database.
//
// This is InstaGuard's equivalent of FortiGate's CMDB (Configuration
...
// Open creates or opens the InstaGuard database at the given path.
